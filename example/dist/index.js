...
(function () {
    ...
    module.exports = module_exports.apply(window);
}).call(window);
...
(function () {
    ...
    _p._$KERNEL = _kernel;
    if (/msie\s+(.*?);/i.test(_useragent) || /trident\/.+rv:([\d\.]+)/i.test(_useragent)) {
        ...
        _kernel.release = _test[document.documentMode] || _test[parseInt(_kernel.version)];
        ...
        if (/firefox\/(.*?)(?=\s|$)/i.test(_useragent)) _kernel.version = RegExp.$1 || '';
        ...
        if (/version\/(.*?)(?=\s|$)/i.test(_useragent)) _kernel.version = RegExp.$1 || '';
    }
...
(function () {
     ...
     */
    var _isTypeOf = function _isTypeOf(_data, _type) {
        try {
    ...
    _p._$loop = function (_obj, _callback, _this) {
        if (_p._$isObject(_obj) && _p._$isFunction(_callback)) {
    ...
    _p._$indexOf = function (_list, _item) {
        var _filter = _p._$isFunction(_item) ? _item : function (_value) {
            return _value === _item;
        },
    ...
    _p._$binSearch = function () {
        var _docheck;
        // do binary search
        var _doSearch = function _doSearch(_list, _low, _high) {
            if (_low > _high) return -1;
            var _middle = Math.ceil((_low + _high) / 2),
                _result = _docheck(_list[_middle], _middle, _list);
            if (_result == 0) return _middle;
            if (_result < 0) return _doSearch(_list, _low, _middle - 1);
    ...
    _p._$format = function () {
        ...
        var _fmtnmb = function _fmtnmb(_number) {
            _number = parseInt(_number) || 0;
            return (_number < 10 ? '0' : '') + _number;
        };
        var _fmtclc = function _fmtclc(_hour) {
            return _hour < 12 ? 0 : 1;
        };
    ...
    _p._$var2date = function (_time) {
        ...
        if (_p._$isString(_time)) {
            _date = new Date(_h.__str2time(_time));
        }
    ...
    _p._$absolute = function () {
        ...
        var _isAbsolute = function _isAbsolute(_uri) {
            _uri = _uri || '';
            return _uri.indexOf('://') > 0 || _uri.indexOf('//') === 0;
        };
        var _doFormat = function _doFormat(_uri) {
            return (_uri || '').split(_reg2)[0].replace(_reg1, '/');
        };
        var _doMergeURI = function _doMergeURI(_uri, _root) {
            // for /a/b/c
            if (_uri.indexOf('/') == 0) return _root.replace(_reg0, '$1') + _uri;
        ...
        return function (_uri, _root) {
            _uri = (_uri || '').trim();
            if (!_isAbsolute(_root)) _root = _base;
            if (!_uri) return _root;
            if (_isAbsolute(_uri)) return _uri;
            _uri = _doMergeURI(_uri, _root);
            _anchor.href = _uri;
            _uri = _anchor.href;
            return _isAbsolute(_uri) ? _uri : _anchor.getAttribute('href', 4); // ie6/7
        };
    }();
    /**
     * 从URL地址中提取源信息
    ...
    _p._$url2origin = function () {
        ...
        return function (_url) {
            if (_reg.test(_url || '')) return RegExp.$1.toLowerCase();
            return '';
        };
    }();
    /**
    ...
    _p._$string2object = function (_string, _split, _decode) {
        ...
        if (!_p._$isFunction(_func)) {
            _func = function _func(v) {
                return !_decode ? v : decodeURIComponent(v);
            };
        }
        // parse string
        _p._$forEach((_string || '').split(_split), function (_name) {
    ...
    _p._$object2string = function (_object, _split, _encode) {
        ...
        // parse object
        _p._$loop(_object, function (_value, _key) {
    ...
    _p._$array2object = function (_list, _filter) {
        var _result = {};
        _p._$forEach(_list, function (_item) {
            var _key = _item;
            if (!!_filter) {
                _key = _filter(_item);
            }
    ...
    _p._$safeDelete = function (_object, _name) {
        if (!_p._$isArray(_name)) {
            ...
            _p._$forEach(_name, function (_item) {
...
(function () {
    ...
    _p.__forIn = function (_obj, _callback, _this) {
        ...
        for (var i = 0, l = _keys.length, _key, _ret; i < l; i++) {
            _key = _keys[i];
            _ret = _callback.call(_this || null, _obj[_key], _key, _obj);
            if (!!_ret) {
                return _key;
            }
        }
...
_element2.default._$getByClassName(document.body, 'j-info')[0].innerHTML = JSON.stringify(_platform2.default, null, 2);
...
(function () {
    ...
    /** @module base/element */
    var NEJ = __webpack_require__(0);
    var _g = __webpack_require__(8);
    var _u = __webpack_require__(2);
    var _v = __webpack_require__(9);
    var _x = __webpack_require__(6);
    ...
    _cspol,
        // css text pool
    _empol = {},
        // elements without id property, eg. document,window
    _dirty = {},
        // temporary element with id
     ...
     */
    _p._$id = _y._$id = function (_element) {
        _element = _p._$get(_element);
        if (!_element) return;
        var _id = !!_element.id ? _element.id : 'auto-id-' + _u._$uniqueID();
        if (!('id' in _element)) {
            _empol[_id] = _element;
        }
        _element.id = _id;
    ...
    _p._$get = function (_element) {
        ...
        // element is node
        if (!_u._$isString(_element) && !_u._$isNumber(_element)) {
            return _element;
        }
        // element is id
     ...
     */
    _p._$getChildren = _y._$getChildren = function (_element, _clazz) {
        _element = _p._$get(_element);
        if (!_element) return null;
        var _list = _h.__getChildren(_element);
        if (!!_clazz) {
            _u._$reverseEach(_list, function (_node, _index, _list) {
    ...
    _p._$getParent = function () {
        var _exmap;
        var _doFilter = function _doFilter(_name, _element) {
            ...
            return !!_p._$attr(_element, _name) || !!_p._$dataset(_element, _name) || _p._$hasClassName(_element, _name);
        };
     ...
     */
    _p._$getByClassName = _y._$getByClassName = function (_element, _class) {
        _element = _p._$get(_element);
        return !_element ? null : _h.__getElementsByClassName(_element, _class.trim());
    };
    /**
     * 根据从兄弟节点中搜索符合条件的节点
     *
     ...
     */
    _p._$getSibling = _y._$getSibling = function () {
        var _doFilter = function _doFilter() {
            return !0;
        };
        return function (_element, _filter) {
            _element = _p._$get(_element);
            ...
            var _next = _conf.backward ? _h.__previousSibling : _h.__nextSibling;
    ...
    _p._$getPageBox = function () {
        ...
        var _getClientBox = function _getClientBox(_list) {
            var _result = 0;
            _u._$forEach(_list, function (_size) {
                if (!_size) return;
                if (!_result) {
                    _result = _size;
                } else {
        ...
        var _farr = [{
            main: 'scroll',
            sub: ['Top', 'Left'],
            func: function func(_key, _body0, _body1) {
                return Math.max(_body0['scroll' + _key], _body1['scroll' + _key]);
            }
        }, {
            main: 'client',
            sub: ['Width', 'Height'],
            func: function func(_key, _body0, _body1) {
                return _getClientBox([_body0['client' + _key], _body0['offset' + _key], _body1['client' + _key], _body1['offset' + _key]]);
            }
        }, {
            main: 'scroll',
            sub: ['Width', 'Height'],
            func: function func(_key, _body0, _body1, _result) {
                return Math.max(_result['client' + _key], _body0['scroll' + _key], _body1['scroll' + _key]);
            }
        }];
        return function (_document) {
            ...
            _u._$forEach(_farr, function (_item) {
                var _main = _item.main;
                _u._$forEach(_item.sub, function (_key) {
                    _result[_main + _key] = _item.func(_key, _body0, _body1, _result);
                });
            });
            return _result;
        };
    ...
    _p._$getMaxBox = function (_org, _max) {
        ...
        // height overflow
        if (_mrto > _orto && _org.height > _max.height) {
            _result.height = _max.height;
            _result.width = _result.height * _orto;
        }
        // width overflow
        if (_mrto < _orto && _org.width > _max.width) {
     ...
     */
    _p._$scrollTo = _y._$scrollTo = function (_element) {
    ...
    _p._$align = function () {
        ...
        var _fmap = {
            ...
            center: function center(_box, _org) {
                return (_box.width - _org.width) / 2;
            },
            right: function right(_box, _org) {
                return _box.width - _org.width;
            },
            top: function top() {
                return 0;
            },
            middle: function middle(_box, _org) {
                return (_box.height - _org.height) / 2;
            },
            bottom: function bottom(_box, _org) {
     ...
     */
    _p._$offset = _y._$offset = function () {
        var _isRoot = function _isRoot(_element) {
            return _element == document.body || _element == document.documentElement;
        };
     ...
     */
    _p._$fullScreen = _y._$fullScreen = function (_element) {
        _element = _p._$get(_element);
        if (!!_element) {
            _h.__fullScreen(_element, _p._$getPageBox());
        }
    };
    /**
     ...
     */
    _p._$mask = _y._$mask = function (_element) {
        _element = _p._$get(_element);
        if (!!_element) {
            _p._$id(_element);
     ...
     * @see module:base/element._$unmask
     */
    _p._$unmask = _y._$unmask = function (_element) {
        _element = _p._$get(_element);
        if (!!_element) {
            _p._$id(_element);
    ...
    _p._$createXFrame = function () {
        var _getFrameSrc = function _getFrameSrc() {
            if (location.hostname == document.domain) {
                return 'about:blank';
            }
            return 'javascript:(function(){document.open();document.domain="' + document.domain + '";document.close();})();';
        };
        var _getFrameWithName = function _getFrameWithName(_name) {
            _name = _name.trim();
            if (!_name) {
            ...
            var _iframe;
            try {
                _iframe = document.createElement('<iframe name="' + _name + '"></iframe>');
     ...
     */
    _p._$remove = _y._$remove = function () {
        var _fmap = {
            img: function img(_node) {
                _node.src = _g._$BLANK_IMAGE;
            },
            iframe: function iframe(_node) {
                _node.src = 'about:blank';
            }
        };
        var _doClear = function _doClear(_node, _tag) {
            if (!_tag) {
            ...
            if (!!_node.getElementsByTagName) {
                _u._$forEach(_node.getElementsByTagName(_tag), _doClear);
            }
        };
     ...
     * @see module:base/element._$removeByEC
     */
    _p._$removeByEC = _y._$removeByEC = function (_element) {
        _element = _p._$get(_element);
        if (!!_element) {
            try {
                _fragment.appendChild(_element);
     ...
     */
    _p._$clearChildren = _y._$clearChildren = function (_element) {
        _element = _p._$get(_element);
        if (!!_element) {
            _u._$reverseEach(_element.childNodes, function (_node) {
                _p._$remove(_node);
            });
        }
    };
     ...
     */
    _p._$wrapInline = _y._$wrapInline = function () {
        var _clazz,
            _reg0 = /\s+/;
        var _doInitStyle = function _doInitStyle() {
            if (!!_clazz) return;
        ...
        return function (_element, _options) {
            ...
            var _nid = _options.nid || '',
                _node = _p._$getByClassName(_parent, _nid || _clazz + '-show')[0];
            if (!_node) {
     ...
     */
    _p._$dataset = _y._$dataset = function (_element, _key, _value) {
        // check element
        ...
        if (_u._$isString(_key)) {
            return _h.__dataset(_p._$get(_element), _key, _value);
        }
        // check map set
     ...
     * @see module:base/element._$attr
     */
    _p._$attr = _y._$attr = function (_element, _name, _value) {
        _element = _p._$get(_element);
        if (!_element) {
            return '';
        }
     ...
     */
    _p._$dom2xml = _y._$dom2xml = function (_element) {
        _element = _p._$get(_element);
     ...
     */
    _p._$dom2object = _y._$dom2object = function (_dom, _obj) {
        _obj = _obj || {};
        _dom = _p._$get(_dom);
        if (!_dom) return _obj;
    ...
    _p._$text2type = function () {
        var _fmap = {
            xml: function xml(_text) {
                return _p._$xml2dom(_text);
            },
            json: function json(_text) {
                try {
     ...
     */
    _p._$style = _y._$style = function (_element, _map) {
        _element = _p._$get(_element);
        if (!!_element) {
     ...
     * @see module:base/element._$setStyle
     */
    _p._$setStyle = _y._$setStyle = function (_element, _name, _value) {
        _element = _p._$get(_element);
        if (!!_element) {
            _h.__setStyleValue(_element, _name, _h.__processCSSText(_value));
        }
    };
    /**
     * 取样式值
     ...
     * @see module:base/element._$getStyle
     */
    _p._$getStyle = _y._$getStyle = function (_element, _name) {
        _element = _p._$get(_element);
        return !_element ? '' : _h.__getStyleValue(_element, _name);
    };
    /**
     * 页面注入脚本
     *
    ...
    _p._$addStyle = function () {
        ...
        return function (_css) {
            ...
            if (!!_css) {
                ...
                _h.__injectCSSText(_node, _h.__processCSSText(_css));
            }
            return _node;
        };
    }();
    ...
    _p._$pushCSSText = function () {
        ...
        return function (_css, _data) {
            ...
            _cspol.push(_css.replace(_reg, function ($1, $2) {
                return _dmap[$2] || $1;
            }));
            return _class;
        };
     ...
     */
    _p._$appendCSSText = _y._$appendCSSText = function (_element, _css) {
        _element = _p._$get(_element);
        return !_element ? null : _h.__appendCSSText(_element, _h.__processCSSText(_css));
    };
    /**
     * 新增样式类，多个样式用空格分开
     *
     ...
     */
    _p._$addClassName = _y._$addClassName = function (_element, _class) {
        if (!_class) {
            return;
        }
        _element = _p._$get(_element);
        if (!!_element) {
            _h.__processClassName(_element, 'add', _class);
        }
    };
    /**
     * 删除样式类，多个样式用空格分开
     ...
     * @see module:base/element._$delClassName
     */
    _p._$delClassName = _y._$delClassName = function (_element, _class) {
        _element = _p._$get(_element);
        if (!!_element) {
            _h.__processClassName(_element, 'remove', _class);
        }
    };
    /**
     ...
     * @see module:base/element._$replaceClassName
     */
    _p._$replaceClassName = _y._$replaceClassName = function (_element, _del, _add) {
        _element = _p._$get(_element);
        if (!!_element) {
            _h.__processClassName(_element, 'replace', _del, _add);
        }
    };
    /**
     ...
     */
    _p._$hasClassName = _y._$hasClassName = function (_element, _class) {
        _element = _p._$get(_element);
        if (!!_element) {
     ...
     */
    _p._$css3d = _y._$css3d = function (_element, _name, _map) {
        _element = _p._$get(_element);
        if (!!_element) {
...
(function () {
    ...
    _p._$getFrameProxy = function (_url) {
        ...
        return _p._$get('frames')[_host] || _host + '/res/nej_proxy_frame.html';
    };
    /**
...
(function () {
     ...
     * @return {Void}
     */
    var _getClientOffset = function _getClientOffset(_event, _type, _name) {
     ...
     * @return {Void}
     */
    var _getPageOffset = function _getPageOffset(_event, _type, _name) {
     ...
     */
    var _doFormatArgs = function _doFormatArgs(_element, _type, _handler, _capture) {
        var _result = {};
        // check element
     ...
     */
    _p._$addEvent = _y._$addEvent = function () {
        // cache event
        // type/handler/link
        var _doCacheEvent = function _doCacheEvent(_type, _source, _real) {
     ...
     * @see module:base/event._$delEvent
     */
    _p._$delEvent = _y._$delEvent = function () {
        var _unCacheEvent = function _unCacheEvent(_type, _conf) {
     ...
     */
    _p._$clearEvent = _y._$clearEvent = function () {
        var _doClearEvent = function _doClearEvent(_id, _name, _list) {
     ...
     */
    _p._$dispatchEvent = _y._$dispatchEvent = function (_element, _type, _options) {
...
(function () {
    ...
    _p.__url2host = function () {
        ...
        return function (_url) {
            _url = _url || '';
            if (_reg.test(_url)) return RegExp.$1;
    ...
    var _doInit = function () {
        ...
        var _doInitProxy = function _doInitProxy(_list) {
            var _map = {};
            if (!_list || !_list.length) {
                return _map;
            }
            for (var i = 0, l = _list.length, _path; i < l; i++) {
                _path = _list[i];
                if (_path.indexOf('://') > 0) _map[_p.__url2host(_path)] = _path;
            }
            return _map;
        };
...
(function () {
    ...
    _p.__parseDOMFromXML = function (_xml) {
        var _root = new DOMParser().parseFromString(_xml, 'text/xml').documentElement;
    ...
    _p.__isNeedPrefixed = function () {
        var _pmap = _u._$array2object(['animation', 'transform', 'transition', 'appearance', 'userSelect', 'box', 'flex', 'column']);
    ...
    _p.__getCSSMatrix = function () {
        ...
        var _doParse = function _doParse(_matrix) {
            var _obj = {};
            if (_reg0.test(_matrix || '')) {
                // 11,12,21,22,41,42
                _u._$forEach(RegExp.$1.split(_reg1), function (_value, _index) {
    ...
    _p.__processCSSText = function () {
        ...
        var _getTransformValue = function _getTransformValue(_tpl, _map) {
            _map = _map || _o;
        ...
        return function (_css) {
            ...
            return _css.replace(_reg0, function ($1, $2) {
                ...
                // parse 3D value
                var _arr = ($2 || '').split('|');
                return _p.__processTransformValue(_arr[0], _u._$query2object(_arr[1])) || $1;
            });
        };
    }();
    /**
    ...
    _p.__processClassName = function (_element, _type, _class) {
        if (_type == 'replace') {
            _p.__processClassName(_element, 'remove', _class);
            _p.__processClassName(_element, 'add', arguments[3]);
            return;
        }
        _u._$forEach(_p.__getClassList(_class), function (_clazz) {
    ...
    _p.__hasClassName = function (_element, _class) {
        ...
        return _u._$indexOf(_p.__getClassList(_class), function (_clazz) {
...
(function () {
    ...
    _p.__checkEvent = function () {
        ...
        var _fmap = {
            enter: function enter(_element, _type, _handler) {
                var _result = {
                    type: 'keypress'
                };
                if (!!_handler) {
        ...
        var _doPrefix = function _doPrefix(_name) {
